...
## Threat modeling
**Sources:** [asvs] [ssdf] [samm] [owasp-cheatsheets]
...
**Sources:** [asvs] [owasp-cheatsheets] [sp-800-63b]
...
## Secrets management
**Sources:** [owasp-cheatsheets] [ssdf]
...
**Sources:** [asvs] [ssdf] [cyclonedx] [spdx] [scorecard]
...
- [owasp-cheatsheets] OWASP Cheat Sheet Series: https://cheatsheetseries.owasp.org/ (Authentication, Authorization, Password Storage, Secrets Management, Cryptographic Storage, Transport Layer Protection, Threat Modeling, Dependency Management)
...
- [owasp-top10] OWASP Top 10: https://owasp.org/www-project-top-ten/
- [llm-top10] OWASP Top 10 for LLM Applications: https://genai.owasp.org/llm-top-10/
- [genai-owasp] OWASP GenAI Security Project: https://genai.owasp.org/
- [nist-ai-rmf] NIST AI Risk Management Framework: https://www.nist.gov/itl/ai-risk-management-framework
- [sp-800-63b] NIST SP 800-63B (identity guidelines): https://pages.nist.gov/800-63-3/sp800-63b.html
- [cyclonedx] [spdx] SBOM formats: https://cyclonedx.org/ · https://spdx.dev/
- [sigstore] Sigstore (artifact signing): https://www.sigstore.dev/
- [scorecard] OpenSSF Scorecard: https://securityscorecards.dev/
