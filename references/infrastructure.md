...
- Terraform: developer.hashicorp.com/terraform (state, backends, lifecycle, import, -refresh-only).
- Kubernetes: kubernetes.io/docs (pods/probes, deployments, resources, HPA) and the official API deprecation guide.
